...
helix1 = helix(pos=wallL.pos, axis=list_balls[0].pos - wallL.pos, raduis=0.2, coils=10, thickness=0.05,
               color=color.magenta)
...
last = len(list_balls)
helix4 = helix(pos=list_balls[last].pos, axis=wallR.pos - list_balls[last].pos, raduis=0.2, coils=10, thickness=0.05,
               color=color.yellow)
