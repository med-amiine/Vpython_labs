"""
* Ball switching color with wall
* __author__ = "Mohammed El Amine Idmoussi"
* A ball is traped inside a box,each wall of the box has a different color
* Every time the ball hit a wall it will gets his color
"""
